...
const INDEX = [
  ...
  { title: 'Translation Excellence',           group: 'Projects',  url: 'translation-excellence.html',            tags: ['translation', 'excellence', 'zoho one', 'creator', 'catalyst', 'inventory', 'rental'] },
  { title: 'TE Zoho Apps',                     group: 'Projects',  url: 'translation-excellence-apps.html',       tags: ['translation', 'apps', 'zoho one', 'crm', 'people', 'analytics', 'workdrive', 'sign'] },
  { title: 'TE Catalyst Projects',             group: 'Projects',  url: 'translation-excellence-catalyst.html',   tags: ['catalyst', 'serverless', 'leave management', 'client portal', 'external auth'] },
  { title: 'Rental & Inventory System',        group: 'Workstream',url: 'translation-excellence.html#rental-inventory', tags: ['rental', 'inventory', 'creator', 'equipment', 'warehouse'] },
  { title: 'Leave Management (Catalyst)',      group: 'Workstream',url: 'translation-excellence-catalyst.html#leave-management', tags: ['leave', 'catalyst', 'serverless', 'hr', 'people'] },
  { title: 'Client Portal (Catalyst)',         group: 'Workstream',url: 'translation-excellence-catalyst.html#client-portal', tags: ['portal', 'catalyst', 'external', 'clients', 'file store'] },
